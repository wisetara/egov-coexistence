...
<script src="<cdn:url value='/resources/global/js/egov/patternvalidation.js?rnd=${app_release_no}' context='/services/egi'/>"></script>
<script src="<cdn:url value='/resources/global/js/jquery-ui/jquery-ui.js' context='/services/egi'/>"></script>
<link src="<cdn:url value='/resources/global/js/jquery-ui/jquery-ui.css' context='/services/egi'/>"></link>
...
<script type="text/javascript" src="/services/EGF/resources/commonyui/yui2.8/element/element-min.js"></script>
<script type="text/javascript" src="/services/EGF/resources/commonyui/yui2.8/connection/connection-min.js"></script>
...
<body class="page-body" oncontextmenu="return false;" onload="loadDropDownCodesFunction();">
	...
	<table class="table table-bordered display-hide" id="result">
		<thead>
			<tr>
				<th width="10%"><spring:message code="hdr.accountcode" /><span class="mandatory1">*</span></th>
				...
				<th width="15%"><spring:message code="lbl.openingdebitbalance" /><span class="mandatory1">*</span></th>
				<th width="15%"><spring:message code="lbl.openingcreditbalance" /><span class="mandatory1">*</span></th>
				<th width="15%"><spring:message code="lbl.narration" /></th>
				<th width="2%"><button type="button" id="add-row" class="btn btn-xs btn-secondary add-row"> <span class="glyphicon glyphicon-plus"></span> </button></th>
			</tr>
		</thead>
		<tbody>
			<tr id="resultrow0">
				...
				<td id="transactionSummaryList[0].accounthead">
				</td>
				<td>
					<form:select path="transactionSummaryList[0].accountdetailtype.id" id="transactionSummaryList[0].accountdetailtype.id" onchange="changeaccountdetailkey(this)" class="form-control yui-dt-dropdown ">
				...
				<td>
					<form:input path="transactionSummaryList[0].openingdebitbalance" type="text" readonly="false" style="text-align:right;" class="form-control mandatoryField patternvalidation mandatory " data-pattern="decimalvalue" id="transactionSummaryList[0].openingdebitbalance" onchange="makeMandatory(this)" />
				</td>
				<td>
					<form:input path="transactionSummaryList[0].openingcreditbalance" type="text" readonly="false" style="text-align:right;" class="form-control mandatoryField patternvalidation mandatory" data-pattern="decimalvalue" id="transactionSummaryList[0].openingcreditbalance" onchange="makeMandatory(this)" />
				</td>
				<td>
					<form:textarea path="transactionSummaryList[0].narration" id="transactionSummaryList[0].narration" class="form-control"></form:textarea>
				</td>
			</tr>
		</tbody>
	</table>
...
<script type="text/javascript" src="/services/EGF/resources/javascript/transactionSummaryHelper.js?rnd=${app_release_no}"></script>
