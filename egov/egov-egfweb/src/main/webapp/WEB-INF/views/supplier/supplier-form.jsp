...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="correspondenceAddress" > <spring:message code="supplier.correspondenceAddress"   /><span class="mandatory"></span>
	</label>
	<div class="col-sm-3 add-margin">
	...
	<label class="col-sm-2 control-label text-right" for="paymentAddress"> <spring:message code="supplier.paymentAddress" />
	</label>
	<div class="col-sm-3 add-margin">
...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="contactPerson"> <spring:message code="supplier.contactPerson" /><span class="mandatory"></span>
	</label>
	...
	<label class="col-sm-2 control-label text-right" for="email"> <spring:message code="supplier.email" />
	</label>
	<div class="col-sm-3 add-margin">
...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="narration"> <spring:message code="supplier.narration" />
	</label>
	<div class="col-sm-3 add-margin">
...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="panNumber"> <spring:message code="supplier.panNo" />
	</label>
	<div class="col-sm-3 add-margin">
...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="bank"> <spring:message code="supplier.bank" />
	</label>
	<div class="col-sm-3 add-margin">
	...
	<label class="col-sm-2 control-label text-right" for="ifscCode"> <spring:message code="supplier.ifscCode" />
	</label>
	<div class="col-sm-3 add-margin">
...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="bankAccount"> <spring:message code="supplier.bankAccount" />
	</label>
	<div class="col-sm-3 add-margin">
	...
	<label class="col-sm-2 control-label text-right" for="registrationNumber"> <spring:message code="supplier.registrationNo" />
	</label>
	<div class="col-sm-3 add-margin">
...
<div class="form-group">
	<label class="col-sm-2 control-label text-right" for="status"> <spring:message code="supplier.status" /><span class="mandatory"></span>
	</label>
	<div class="col-sm-3 add-margin">
