...
<form:form role="form" action="/services/EGF/contractor/update" modelAttribute="contractor" id="contractorForm" cssClass="form-horizontal form-groups-bordered" enctype="multipart/form-data">
