...
public class ReportAction extends BaseFormAction {
	...
	protected void getHeaderFields() {
		final List<AppConfigValues> appConfigList = appConfigValueService.getConfigValuesByModuleAndKey(
				FinancialConstants.MODULE_NAME_APPCONFIG, "REPORT_SEARCH_MISATTRRIBUTES");
	...
	public void validate() {
		...
		checkMandatoryField(Constants.SUBSCHEME, Constants.SUBSCHEME, reportSearch.getSubScheme(),
		...
		checkMandatoryField(Constants.FUNCTION, Constants.FUNCTION, reportSearch.getFunction(),
