...
public class BudgetCheckConfigController {
	...
	public String update(@ModelAttribute final BudgetControlType budgetControlType, final BindingResult errors,
		...
		redirectAttrs.addFlashAttribute("message",
				messageSource.getMessage("msg.budgetcheckconfig.success", null, null));
