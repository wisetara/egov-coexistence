...
public class BankAccountServiceMappingResponse {
    ...
    public void setBankAccountServiceMapping(List<BankAccountServiceMapping> bankAccountServiceMapping) {
        this.bankAccountServiceMapping = bankAccountServiceMapping;
    }
